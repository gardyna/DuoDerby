...
namespace UnityStandardAssets.Vehicles.Car {
	public class Launcher : MonoBehaviour {
		...
		public void rotate(float v) {
			...
			crosshair.transform.position = new Vector3(((gameCanvas.rect.width/2)*v)+(gameCanvas.rect.width/2), crosshair.transform.position.y, crosshair.transform.position.z);
